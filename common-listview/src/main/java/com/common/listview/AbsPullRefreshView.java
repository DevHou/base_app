...
/**
 * Created by houlijiang on 2018/5/27.
 */
public class AbsPullRefreshView extends FrameLayout implements RefreshHeader, AbsListView.IPtrHeaderUI {

    public AbsPullRefreshView(Context context) {
        super(context);
    }
    ...
    public AbsPullRefreshView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    @Override
    public void onUIPositionChange(boolean isUnderTouch, AbsListView.PtrStatus status, float offset,
