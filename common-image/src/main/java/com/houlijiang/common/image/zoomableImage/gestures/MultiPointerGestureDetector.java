package com.houlijiang.common.image.zoomableImage.gestures;
...
public class MultiPointerGestureDetector {
    ...
    public void reset() {
        ...
        for (int i = 0; i < MAX_POINTERS; i++) {
            mId[i] =
                Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH ? -1 : MotionEvent.INVALID_POINTER_ID;
        }
    }
