...
/**
 * Created by houlijiang on 15/8/27.
 *
 * fresco配置
 */
public class ConfigConstants {
    ...
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "cache_small";// 小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "cache_normal";// 默认图所放路径的文件夹名
     ...
     * 初始化配置，单例
     */
    public static ImagePipelineConfig getImagePipelineConfig(Context context, File cacheDir) {
        if (sImagePipelineConfig == null) {
            sImagePipelineConfig = configureCaches(context, cacheDir);
        }
     ...
     * 初始化配置
     */
    private static ImagePipelineConfig configureCaches(Context context, File cacheFile) {
        // 内存配置
    ...
    public static RoundingParams getRoundingParams() {
        ...
        // roundingParams.setCornersRadii(topLeft, topRight, bottomRight, bottomLeft)//fresco:roundTopLeft="true"
        // fresco:roundTopRight="false" fresco:roundBottomLeft="false" fresco:roundBottomRight="true"
    ...
    // 图片显示
    public static ImageRequest getImageRequest(CommonImageView view, String uri) {
    ...
    public static DraweeController getDraweeController(ImageRequest imageRequest, CommonImageView view) {
