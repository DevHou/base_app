package com.houlijiang.common.image.zoomableImage.zoomable;
...
/**
 * Created by houlijiang on 15/9/6.
 */
public class ZoomableDraweeView extends DraweeView<GenericDraweeHierarchy> implements ZoomableController.Listener {
    ...
    private void setControllersInternal(@Nullable DraweeController controller,
    ...
    private void updateZoomableControllerBounds() {
        ...
        FLog.v(TAG, "updateZoomableControllerBounds: view %x, view bounds: %s, image bounds: %s", this.hashCode(),
